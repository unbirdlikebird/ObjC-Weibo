...
#ifndef ObjC_Weibo_Macros_h
#define ObjC_Weibo_Macros_h
...
#define RGBRANDOM               RGBACOLOR(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256), 1.0f)
//NSUserDefaults 实例化
